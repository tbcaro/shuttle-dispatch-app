...
interface AssignmentRepository {
    fun findAssignments(windowStart: Time, windowEnd: Time): List<AssignmentEntity>//windowStart and windowEnd will typically be midnight at the start of a day and 11:59PM at the end of the same day
    fun findAssignmentStops(assignID: Int): List<AssignmentStopEntity>
    fun addAssignments(AssignmentEntities: List<AssignmentEntity>)
